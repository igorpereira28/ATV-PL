        ...
        <>
          <li>
            <a
              ...
              href="#"
              onClick={(e) =>
                this.props.seletorView("Clientes que mais consumiram produtos", e)
              }
            >
          ...
          <li>
            <a
              ...
              href="#"
              onClick={(e) =>
                this.props.seletorView("Clientes que mais consumiram serviços", e)
              }
            >
          ...
          <li>
            <a
              ...
              href="#"
              onClick={(e) =>
                this.props.seletorView("Produtos mais consumidos por tipo e raça de pets", e)
              }
            >
          ...
          <li>
            <a
              ...
              href="#"
              onClick={(e) =>
                this.props.seletorView("Serviços mais consumidos por tipo e raça de pets", e)
              }
            >
